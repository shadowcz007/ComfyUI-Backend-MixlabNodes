...
class FaceRestoreHelper(object):
    ...
    def __init__(self,
        ...
        if self.det_model == 'dlib':
            ...
            self.face_detector = init_detection_model(dir_path,det_model, half=False, device=self.device)

        # init face parsing model
        self.use_parse = use_parse
        self.face_parse = init_parsing_model(dir_path,model_name='parsenet', device=self.device)
