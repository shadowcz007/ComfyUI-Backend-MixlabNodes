...
def init_detection_model(dir_path,model_name, half=False, device='cuda'):
    
    if model_name in ['detection_mobilenet0.25_Final','detection_Resnet50_Final']:
        model = init_retinaface_model(dir_path,model_name, half, device)
...
def init_retinaface_model(dir_path,model_name, half=False, device='cuda'):
    # print(dir_path,model_name,model_name == 'detection_mobilenet0.25_Final')
    if model_name == 'detection_Resnet50_Final':
        model = RetinaFace(network_name='resnet50', half=half)
        model_url = 'https://github.com/sczhou/CodeFormer/releases/download/v0.1.0/detection_Resnet50_Final.pth'
        model_path=os.path.join(dir_path,"detection_Resnet50_Final.pth")
    elif model_name == 'detection_mobilenet0.25_Final':
